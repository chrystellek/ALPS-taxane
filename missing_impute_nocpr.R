# Code for imputation of any missing genotypes for taxane/ALPS project 
# Last updated: 26 September 2024 by Chrystelle Kiang

# This version is if cpr can't be added
...
calculate_mean <- function(df, var_list) {
  df %>%
    rowwise() %>%
...
imp_agg <- calculate_mean(imp_long, gene_vars)
